            ...
            <div>
              {lang !== 'en' ? (<Fragment>
                <ul className={classes['navigation-icons']}>
                  ...
                  <li variants={item} className={`${classes['navigation-list-item']} ${classes['icon-list-item']}`}><IconRounded link="https://www.facebook.com/muzeibotev" icon={<FacebookRounded />} /></li>
                ...
                <ul className={`${classes['navigation-icons']} ${classes['navigation-icons--en']}`}>
                  {/* <li variants={item} className={`${classes['navigation-list-item']} ${classes['icon-list-item']}`}><IconRounded link="phone" icon={<Phone />} /></li>
                ...
                <ul className={`${classes['navigation-main']} ${classes['navigation-main--en']}`}>
